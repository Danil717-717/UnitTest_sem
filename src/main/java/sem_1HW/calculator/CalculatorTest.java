...
//         assert 8 == Calculator.calculation(2, 6, '+');
//
//         assertThat(Calculator.calculation(2, 6, '+')).isEqualTo(7);

        // Проверка ДЗ:
        assert 1800.0 == Calculator.calculatingDiscount(2000, 10);
        assert 1800 == Calculator.calculatingDiscount(2000, 10);
        assert 4250 == Calculator.calculatingDiscount(5000, 15);
        assert 4250.0 == Calculator.calculatingDiscount(0, 15);
